...
Универсальный mask-пайплайн сохранен. Для старых workflow основная нода и первые шесть выходов не изменили смысл. Дополнительно доступна нода **Batch Image Crop By Mask or Face Advanced**, в которой `crop_mask` необязателен:
